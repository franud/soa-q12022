  ...
  main(void)
{
  ...
  printk("Prueba de cambio de colores??? Es esto letras negras y fondo gris????aaaaaaaaaaahhsdhjjajhsdhjhjhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh\nSi lo es!!! yay!!!\neee\ne\ne\neee\ne\n");
